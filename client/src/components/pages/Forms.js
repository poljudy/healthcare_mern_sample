            ...
            <Card className={classes.root}>
              ...
              <CardActions>
                <Button
                  ...
                  href="https://hushforms.com/contactcpc"
                >
                  After you have scheduled your first appointment, please
                  request the new patient forms
                </Button>
...
<Link to="../../Forms/RELEAS2121312.doc" target="_blank" download>Secondary Release Form</Link>
          ...
          <ListItem>
            <Link to="../../Forms/mianReleaseForm.doc" target="_blank" download>
              Release of Information
            </Link>
          </ListItem>
          <ListItem>
            <Link
              to="../../Forms/TELETHERAPYINFORMEDCONSENT.doc"
              target="_blank"
              download
            >
              Teletherapy Release Form
            </Link>
          </ListItem>
        </List>
      </div>
